...
export const FACTORY_PROJECTS = [
  ...
  { asset: '05-oishi-new-uht-plant.webp', heading: 'Oishi - New UHT Plant', location: 'NAVANAKORN ยท PATHUM THANI', description: 'Mechanical & SCADA System' },
  { asset: '06-oishi-central-catering.webp', heading: 'Oishi - Renovate Central Catering', location: 'NAVANAKORN ยท PATHUM THANI', description: 'Structure, Architecture, Mechanical & Electrical System' },
